...
import { SM01 } from "@/slides/sm/SM01";
import { SM02 } from "@/slides/sm/SM02";
import { SM03 } from "@/slides/sm/SM03";
import { SM04 } from "@/slides/sm/SM04";
import { SM05 } from "@/slides/sm/SM05";
import { SM06 } from "@/slides/sm/SM06";
import { SM07 } from "@/slides/sm/SM07";
import { SM08 } from "@/slides/sm/SM08";
import { SM09 } from "@/slides/sm/SM09";
import { SM10 } from "@/slides/sm/SM10";

type SlideEntry = { id: string; title: string; node: React.ReactNode };

const SLIDES: SlideEntry[] = [
  { id: "01", title: "Capa", node: <SM01 /> },
  { id: "02", title: "Apresentador", node: <SM02 /> },
  { id: "03", title: "A pergunta errada", node: <SM03 /> },
  { id: "04", title: "Posicionamento", node: <SM04 /> },
  { id: "05", title: "Persona", node: <SM05 /> },
  { id: "06", title: "Tom de voz", node: <SM06 /> },
  { id: "07", title: "Diferenciação", node: <SM07 /> },
  { id: "08", title: "Pilares de conteúdo", node: <SM08 /> },
  { id: "09", title: "Identidade visual", node: <SM09 /> },
  { id: "10", title: "Marca antes de mídia", node: <SM10 /> },
];

export function SocialMediaPresentation() {
